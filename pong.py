...
try:
    paddle_speed = int(sys.argv[1])  # Validate user input to prevent large or negative values
    if paddle_speed <= 0 or paddle_speed > 10:
        raise ValueError('Invalid paddle speed')
